...
MIGRATION_MODULES = {"sites": "simlane.contrib.sites.migrations"}
...
MIDDLEWARE = [
    ...
    "simlane.core.middleware.AuthenticationRequiredMiddleware",
...
ADMINS = [("""Akash Vibhute""", "akash@simlane.app")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "simlane.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "simlane.users.forms.UserSignupForm"}
...
CACHES = {
    "default": {
        ...
        "LOCATION": f"{REDIS_URL}/2",  # Database 2 - View & Fragment Cache
        "OPTIONS": {
    ...
    "sessions": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": f"{REDIS_URL}/1",  # Database 1 - Sessions
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        },
    ...
    "query_cache": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": f"{REDIS_URL}/3",  # Database 3 - Query Cache
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        },
    },
    "api_cache": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": f"{REDIS_URL}/4",  # Database 4 - API Cache
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        },
    },
