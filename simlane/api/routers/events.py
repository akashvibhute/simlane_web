...
from simlane.teams.models import TeamAllocation, TeamAllocationMember, TeamEventStrategy, StintAssignment
from simlane.api.schemas.events import (
    TeamAllocation as TeamAllocationSchema,
    TeamAllocationCreate,
    TeamAllocationUpdate,
    TeamAllocationMember as TeamAllocationMemberSchema,
    TeamEventStrategy as TeamEventStrategySchema,
    TeamEventStrategyCreate,
    StintAssignment as StintAssignmentSchema,
    StintAssignmentCreate,
)
...
def create_team_allocation(request: HttpRequest, allocation_data: TeamAllocationCreate):
    ...
    from simlane.teams.models import ClubEvent, ClubMember
...
def update_team_allocation(request: HttpRequest, allocation_id: int, updates: TeamAllocationUpdate):
...
def create_team_strategy(request: HttpRequest, allocation_id: int, strategy_data: TeamEventStrategyCreate):
...
@router.get("/{allocation_id}/strategies/{strategy_id}/stints", response=List[StintAssignmentSchema])
def list_stint_assignments(request: HttpRequest, allocation_id: int, strategy_id: int):
    """List stint assignments for a strategy."""
    allocation = get_object_or_404(TeamAllocation, id=allocation_id)
    strategy = get_object_or_404(TeamEventStrategy, id=strategy_id, allocation=allocation)
...
@router.post("/{allocation_id}/strategies/{strategy_id}/stints", response=StintAssignmentSchema)
def create_stint_assignment(request: HttpRequest, allocation_id: int, strategy_id: int, stint_data: StintAssignmentCreate):
