...
from simlane.sim.models import Event, SimCar, EventInstance
from .models import (
...
class ClubEventCreateForm(forms.ModelForm):
    ...
    class Meta:
        model = ClubEvent
        fields = [
            'base_event', 'title', 'description', 'signup_deadline',
            'max_participants', 'requires_team_assignment',
            'auto_assign_teams', 'team_size_min', 'team_size_max'
        ]
        widgets = {
            ...
            'requires_team_assignment': forms.CheckboxInput(attrs={
                'class': 'form-check-input',
            }),
            'auto_assign_teams': forms.CheckboxInput(attrs={
                'class': 'form-check-input',
            }),
...
class EventSignupForm(forms.ModelForm):
    ...
    class Meta:
        model = EventSignup
        fields = [
            'can_drive', 'can_spectate', 'experience_level',
            'primary_sim_profile', 'availability_notes',
            'max_stint_duration', 'min_rest_duration', 'notes'
        ]
        widgets = {
            'can_drive': forms.CheckboxInput(attrs={
                'class': 'form-check-input',
            }),
            'can_spectate': forms.CheckboxInput(attrs={
                'class': 'form-check-input',
            }),
            'experience_level': forms.Select(attrs={
                'class': 'form-control',
            }),
            'primary_sim_profile': forms.Select(attrs={
                'class': 'form-control',
            }),
            ...
            'max_stint_duration': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 10,
                'max': 240,
                'placeholder': 'Minutes'
            }),
            'min_rest_duration': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 10,
                'max': 240,
                'placeholder': 'Minutes'
...
class EventSignupAvailabilityForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'preferred_stint_duration': forms.NumberInput(attrs={
                'class': 'form-control',
                'min': 10,
                'max': 240,
                'placeholder': 'Minutes'
